...
<b>: : СТАРТ-МЕНЮ : :</b>
⠀
<b>«Т3КСТ»</b> — символьный режим вывода: машина отправляет копируемое сообщение из символов в чат.
⠀
<b>«ГР4ФИК4»</b> — основной режим: преобразует фото, видео и .GIF в цветной детально настраиваемый рендер.</blockquote>
<blockquote expandable="true">
...
⠀
<b>«FPS»</b> — регулирует частоту обновления кадров: скорость, с которой Ядро реагирует на мир</blockquote>
...
⠀
*для фронтальной вспышки: чем выше яркость экрана - тем ярче кадр</blockquote>
<blockquote expandable="true">
<b>: : ПАНЕЛЬ РЕЖИМОВ : :</b>
⠀
