...
<blockquote><b>«ВСПЫШКА» </b> и <b>«ТАЙМЕР» </b> — маленькие круглые иконки, помогающие чуть подсветить экран (для фронтальной вспышки, чем выше яркость на телефоне - тем лучше) или поставить таймер на 3 / 10 секунд</blockquote>
<blockquote expandable="true">
<b>: : ПАНЕЛЬ РЕЖИМОВ : :</b>
⠀
