...
<blockquote expandable="true">
<b>«ВСПЫШКА» </b> и <b>«ТАЙМЕР» </b> — маленькие круглые иконки внизу экрана, помогающие подсветить кадр или поставить таймер на 3 / 10 секунд.
⠀
*для фронтальной вспышки - чем выше яркость на устройстве, тем ярче и детальнее будет кадр</blockquote>
<blockquote expandable="true">
<b>: : ПАНЕЛЬ РЕЖИМОВ : :</b>
⠀
