...
<br><br>*при наличии единственного источника вывода или внутри режима <b>«Ф0Т0» / «ВИД30»</b> работает как «отзеркаливание»</blockquote>
<blockquote expandable="true">
<b>: : ПАНЕЛЬ НАСТРОЕК : :</b>
<b>«Н4Б0Р»</b> — формирует алфавит символов;
<br><br>*помимо готовых пресетов доступен <b>«ручной ввод»</b> — инновация, позволяющая ядру собирать изображение из введённых символов на основе алгоритма градации яркости. Используй пробелы и знаки пунктуации для детализации изображения
<br><br><b>«Р4ЗМЕР»</b> — определяет количество символов (чем выше, тем чётче детали);
<br><br><b>«К0НТР4СТ»</b> — усиливает разницу между светом и тенью;
<br><br><b>«Г4ММ4»</b> — управляет мягкостью переходов, влияя на глубину изображения;
<br><br><b>«СТИЛЬ»</b> — раздел готовых цветовых пресетов;
<br><br><b>«Т3КСТ» / «Ф0Н»</b> — задают цвет текста и фона (в <b>RGB / HSL / HEX</b>-коде);
<br><br><b>«ИНВ3РСИЯ»</b> — меняет полярность вывода: «СВЕТ = ТЬМА», и наоборот;
<br><br><b>«FPS»</b> — регулирует частоту обновления кадров: скорость, с которой Ядро реагирует на мир
</blockquote>
...
<br><br><b>«К4М3Р4»</b> = непрерывное наблюдение
<br><br><b>«В1Д30»</b> = запись последовательности
</blockquote>
...
<code>${link}</code>
<br><br>За каждого приведённого адепта, который активирует ядро по твоей ссылке и впервые сгенерирует файл/видео:
<blockquote>— система выдаст тебе <code>+[15]</code> импульсов сразу
<br><br>— будет выдавать по 20% от всех его пополнений энергии</blockquote>
`;
  await sendMessage(
    fromId,
    msgHtml,
...
<br><br><b>Ф0Т0 = 5 ИМПУJIЬС0В</b>
<br><br><b>ВИД30 = 15 ИМПУJIЬС0В</b></blockquote>`,
