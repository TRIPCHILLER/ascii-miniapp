...
${TG_GAP}*при наличии единственного источника вывода или внутри режима <b>«Ф0Т0» / «ВИД30»</b> работает как «отзеркаливание»</blockquote>
<blockquote expandable="true">
<b>: : ПАНЕЛЬ НАСТРОЕК : :</b>
<b>«Н4Б0Р»</b> — формирует алфавит символов;
${TG_GAP}*помимо готовых пресетов доступен <b>«ручной ввод»</b> — инновация, позволяющая ядру собирать изображение из введённых символов на основе алгоритма градации яркости. Используй пробелы и знаки пунктуации для детализации изображения
${TG_GAP}
...
${TG_GAP}— будет выдавать по 20% от всех его пополнений энергии</blockquote>
`;
  await sendMessage(
    fromId,
    msgHtml,
